    ...
    public class FuncionariosDAO : conexao
    {
        ...
        public void Salvar(Funcionarios funcionarios)
        {
            try
            {
                ...
                comando = new MySqlCommand("INSERT INTO tb_funcionario(nomeFuncionario,sobrenomeFuncionario,emailFuncionario,telefoneFixoFunc,telefoneCelularFunc,enderecoFuncionario,cidadeFuncionario,estadoFuncionario,bairroFuncionario,cepFuncionario,numeroResidenciaFuncionario,complementoFuncionario) VALUES (@nome,@sobrenome,@email,@TelefoneFixo,@TelefoneCelular,@endereco,@cidade,@estado,@bairro,@cep,@numeroResidencia,@complemento)", conection);
