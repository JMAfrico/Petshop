        ...
        private void validarAcesso()
        {
            ...
            login.verificarLogin(txtlogin.Text, txtSenha.Text);
            {
                if (teste_login.Checked == true)
                {
                    ...
                    if ((horarioAtual < horarioInicial) || (horarioAtual > horarioLimite))
                    {
                        MessageBox.Show("Acesso ao sistema:  09:00 as 18:00 hrs", "Acesso não autorizado", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
