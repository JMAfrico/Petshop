...
namespace Consultas_medicas
{
    ...
    public partial class Form_veterinario : Form
    {
        ...
        private void salvar(Veterinarios veterinarios)//esse método deve ser privado
        {
            try
            {
                if (txtNome.Text.Trim() == string.Empty || 
                    ...
                    txtEspecializacao.Text.Trim() == string.Empty ||
        ...
        private void dtVeterinario_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            lblEspec.Text = dtVeterinario.CurrentRow.Cells["ESPECIALIZACAO"].Value.ToString();
            ...
            txt_estado.Text = dtVeterinario.CurrentRow.Cells[7].Value.ToString();
            txt_cidade.Text = dtVeterinario.CurrentRow.Cells[6].Value.ToString();
            txtEnd.Text = dtVeterinario.CurrentRow.Cells[5].Value.ToString();
            txtBairro.Text = dtVeterinario.CurrentRow.Cells[8].Value.ToString();
            txtCep.Text = dtVeterinario.CurrentRow.Cells[9].Value.ToString();
            txtNum.Text = dtVeterinario.CurrentRow.Cells[10].Value.ToString();
            txtComplem.Text = dtVeterinario.CurrentRow.Cells[11].Value.ToString();
            txtEmail.Text = dtVeterinario.CurrentRow.Cells[12].Value.ToString();
            txtelfixo.Text = dtVeterinario.CurrentRow.Cells[13].Value.ToString();
            txtelCelular.Text = dtVeterinario.CurrentRow.Cells[14].Value.ToString();
