...
namespace Consultas_medicas
{
    ...
    public partial class Form_Funcionario : Form
    {
        ...
        private void salvar(Funcionarios funcionarios)
        {
            try
            {
                if (txtNome.Text.Trim() == string.Empty || 
                    txtSobrenome.Text.Trim() == string.Empty ||
        ...
        private void dtFuncionario_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            lbl_cidade.Text = dtFuncionario.CurrentRow.Cells[7].Value.ToString();
            lbl_estado.Text = dtFuncionario.CurrentRow.Cells[8].Value.ToString();
            lblBairro.Text = dtFuncionario.CurrentRow.Cells[9].Value.ToString();
            lblCep.Text = dtFuncionario.CurrentRow.Cells[10].Value.ToString();
            lblNumero.Text = dtFuncionario.CurrentRow.Cells[11].Value.ToString();
            lblComplemento.Text = dtFuncionario.CurrentRow.Cells[12].Value.ToString();
            ...
            txt_cidade_func.Text = dtFuncionario.CurrentRow.Cells[7].Value.ToString();
            txt_estado_func.Text = dtFuncionario.CurrentRow.Cells[8].Value.ToString();
            txtBairro.Text = dtFuncionario.CurrentRow.Cells[9].Value.ToString();
            txtCep.Text = dtFuncionario.CurrentRow.Cells[10].Value.ToString();
            txtNumero.Text = dtFuncionario.CurrentRow.Cells[11].Value.ToString();
            txtComplemento.Text = dtFuncionario.CurrentRow.Cells[12].Value.ToString();
